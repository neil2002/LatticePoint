...
<div class="container mx-auto p-4">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="space-y-2">
            ...
            <textarea 
            v-model="userPrompt" 
            placeholder="e.g., 'Show me a bar chart of sales by region' or 'Calculate the average revenue by product category'"
    ...
    <!-- (Optional) Local Preview of Processed Chart -->
...
methods: {
    ...
    goToDashboard() {
    console.log(this.header, this.rows);
    // Pass the raw uploaded data (headers and rows) to the dashboard builder.
    if (!this.file || this.rows.length === 0) {
